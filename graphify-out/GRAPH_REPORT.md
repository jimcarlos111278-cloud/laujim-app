...
## Corpus Check
- 116 files · ~139,763 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1121 nodes · 2057 edges · 127 communities (86 shown, 41 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `64469b6c`
...
### Community 1 - "App.jsx"
Cohesion: 0.06
Nodes (51): react, api, App(), ErrorBoundary, Modal(), COLORS, CustomTooltip(), getChartData() (+43 more)
...
### Community 9 - "getBase"
Cohesion: 0.08
Nodes (49): uploadFile(), AdminRoute(), ProtectedRoute(), Layout(), navItems, VersionBanner(), versionIsNewer(), Chat() (+41 more)
...
### Community 11 - "api.js"
Cohesion: 0.10
Nodes (34): CLOUD_COLLECTIONS, createItem(), deleteItem(), getDataVersion(), getServerVersion(), refreshAllFromServer(), serverReq(), startCloudPolling() (+26 more)
...
### Community 28 - "pre-whatsapp-bot/package.json"
Cohesion: 0.29
...
## Knowledge Gaps
- **426 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `express` (+421 more)
...
- **Why does `react` connect `App.jsx` to `Settings.jsx`, `getBase`, `.oxlintrc.json`, `api.js`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `getBase()` connect `getBase` to `Settings.jsx`, `App.jsx`, `api.js`?**

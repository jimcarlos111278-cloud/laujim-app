...
## Summary
- 1119 nodes · 2053 edges · 109 communities (79 shown, 30 thin omitted)
...
### Community 1 - "App.jsx"
Cohesion: 0.05
Nodes (76): react, api, Layout(), navItems, Modal(), COLORS, CustomTooltip(), getChartData() (+68 more)
...
## Knowledge Gaps
- **425 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `express` (+420 more)

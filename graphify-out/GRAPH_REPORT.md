...
Cohesion: 0.14
Nodes (29): iconMap, ThemeSelector(), Settings(), callerScreeningPlugin(), getAuthorizedSmsMessages(), getCallScreeningStatus(), nativeAndroid(), normalizedPhone() (+21 more)

### Community 1 - "ApartmentDetail.jsx"
Cohesion: 0.07
Nodes (53): react, api, Modal(), COLORS, CustomTooltip(), getChartData(), getPaymentStatus(), PaymentHistoryChart() (+45 more)
...
### Community 11 - "api.js"
Cohesion: 0.16
Nodes (16): CLOUD_COLLECTIONS, createItem(), deleteItem(), getDataVersion(), serverReq(), updateItem(), uploadFile(), collections (+8 more)
...
Cohesion: 0.23
Nodes (14): stopCloudPolling(), stopDataVersionPolling(), Login(), clearAuth(), getTenantApartmentId(), isAdmin(), isTenant(), login() (+6 more)
...
Cohesion: 0.18
Nodes (12): getServerVersion(), Layout(), navItems, PublicApartments(), WhatsAppContacts(), cloudRequest(), formatDate(), MediaMessage() (+4 more)
...
Cohesion: 0.22
Nodes (12): refreshAllFromServer(), startCloudPolling(), startDataVersionPolling(), AdminRoute(), PrivateApp(), ProtectedRoute(), initDB(), getPredialUrl() (+4 more)
...
## Knowledge Gaps
- **447 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `$schema`, `oxc`, `react/rules-of-hooks` (+442 more)

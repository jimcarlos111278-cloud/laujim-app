...
public class ScraperWorkerPlugin extends Plugin {
    ...
    public void configure(PluginCall call) {
        ...
        String backupServerUrl = call.getString("backupServerUrl", ScraperWorkerStore.defaultBackupServer());
        ...
        ScraperWorkerStore.configure(
            getContext(),
            serverUrl.trim(),
            backupServerUrl == null || backupServerUrl.trim().isEmpty() ? ScraperWorkerStore.defaultBackupServer() : backupServerUrl.trim(),
            token.trim(),
    ...
    private JSObject status() {
        ...
        result.put("serverUrl", ScraperWorkerStore.serverUrl(context));
        result.put("activeServerUrl", ScraperWorkerStore.activeServerUrl(context));
        result.put("backupServerUrl", ScraperWorkerStore.backupServerUrl(context));

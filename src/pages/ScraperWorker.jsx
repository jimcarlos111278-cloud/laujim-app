      ...
      {supportsAndroidScraperWorker() && (
        <section className="rounded-xl border border-green-200 bg-green-50 p-5 shadow-sm dark:border-green-900/50 dark:bg-green-900/20">
          ...
          <div className="mt-3 grid gap-2 text-xs sm:grid-cols-2">
            ...
            <div className="rounded-lg border border-green-200 bg-white/80 p-3 dark:border-green-800/60 dark:bg-gray-900/40 sm:col-span-2">
              <p className="text-gray-500 dark:text-gray-400">Failover de servidor</p>

      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div data-settings-panel="device" className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Descarga siempre la versión publicada más reciente de Laujim para Android.</p>
            <a href={`${getRawBase()}/app-debug.apk?v=1.0.80`} download className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium mb-2">
              <Download className="w-4 h-4" /> Descargar APK 1.0.80
          </a>
        </div>

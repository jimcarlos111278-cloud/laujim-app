...
import { getNotifConfig, cancelAllNotifications } from './utils/localNotifications';
import { installFailoverFetch } from './utils/failoverFetch';

installFailoverFetch();
...
function PrivateApp() {
  ...
  useEffect(() => {
    ...
    if (notificationConfig.payments === false) cancelAllNotifications();

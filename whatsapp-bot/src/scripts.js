const DEFAULTS = {
  ...
  auth_success: '✅ *Autenticado correctamente*\n\nAhora todos tus mensajes serán reenviados al grupo de tu apartamento. Los administradores te responderán allí.',
  ...
  group_who: 'Inquilino autenticado: *{name}* ({caller})',
